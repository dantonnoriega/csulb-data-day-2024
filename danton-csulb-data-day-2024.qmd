...
- Safari
  - Menu *Settings (`cmd+,`) > Advanced > "Show Web Features for Web Developers"*
  - Menu *Develop > Show Web Inspector (`cmd+alt+i`)*
- Chrome
  - Menu *View > Developer > "Developer Tools" (`cmd+alt+i`)*
...
- Go to [etf.com/VOO](https://www.etf.com/VOO)
  - *View Source / Show Web Inspector* (`cmd+alt+i `) > *Network*
- Click *Holdings*
...
- [`get-etf_fund_holdings.R`](R/get-etf_fund_holdings.R)
- [`get-etf_gh_files.R`](R/get-etf_gh_files.R)
